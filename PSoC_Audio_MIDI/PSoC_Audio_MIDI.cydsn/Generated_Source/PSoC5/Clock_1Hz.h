...
#define Clock_1Hz_SetDivider(clkDivider)         Clock_1Hz_SetDividerRegister(clkDivider, 1u)
#define Clock_1Hz_SetDividerValue(clkDivider)    Clock_1Hz_SetDividerRegister((clkDivider) - 1u, 1u)
...
#define Clock_1Hz_SetPhaseValue(clkPhase)        Clock_1Hz_SetPhaseRegister((clkPhase) + 1u)
#endif /* defined(Clock_1Hz__CFG3) */

...
// Timer_v2_80(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=false, CaptureMode=0, CONTROL3=1, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeviceFamily=PSoC5, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=true, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=1, NumberOfCaptures=1, param45=1, Period=1299, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UsesHWEnable=0, VerilogSectionReplacementString=sT16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_80, CY_CONFIG_TITLE=Timer_Display, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_Display, CY_INSTANCE_SHORT_NAME=Timer_Display, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=80, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Timer_Display, )
...
// OpAmp_v1_90(Mode=1, Power=2, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONFIG_TITLE=BuffAmp, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=WaveDAC8_2:BuffAmp, CY_INSTANCE_SHORT_NAME=BuffAmp, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=WaveDAC8_2_BuffAmp, )
...
module top ;
    ...
    Timer_v2_80_0 Timer_Mode (
        ...
        .tc(Net_354),
        .trigger(1'b1));
    defparam Timer_Mode.CaptureCount = 2;
    defparam Timer_Mode.CaptureCounterEnabled = 0;
    defparam Timer_Mode.DeviceFamily = "PSoC5";
    defparam Timer_Mode.InterruptOnCapture = 0;
    defparam Timer_Mode.InterruptOnTC = 1;
    defparam Timer_Mode.Resolution = 16;
    defparam Timer_Mode.SiliconRevision = "0";
	...
	wire [0:0] tmpOE__Pin_Dice_2_net;
	wire [0:0] tmpFB_0__Pin_Dice_2_net;
	wire [0:0] tmpIO_0__Pin_Dice_2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Dice_2_net;
	electrical [0:0] tmpSIOVREF__Pin_Dice_2_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pin_Dice_2
		 (.oe(tmpOE__Pin_Dice_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Dice_2_net[0:0]}),
		  .io({tmpIO_0__Pin_Dice_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Dice_2_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Dice_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Dice_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Dice_1_net;
	wire [0:0] tmpFB_0__Pin_Dice_1_net;
	wire [0:0] tmpIO_0__Pin_Dice_1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Dice_1_net;
	electrical [0:0] tmpSIOVREF__Pin_Dice_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Dice_1
		 (.oe(tmpOE__Pin_Dice_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Dice_1_net[0:0]}),
		  .io({tmpIO_0__Pin_Dice_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Dice_1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Dice_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Dice_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Dice_LED_2_net;
	wire [0:0] tmpFB_0__Pin_Dice_LED_2_net;
	wire [0:0] tmpIO_0__Pin_Dice_LED_2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Dice_LED_2_net;
	electrical [0:0] tmpSIOVREF__Pin_Dice_LED_2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("08ce2a49-4858-4c4f-9e4c-ec2b23dd66b3"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Dice_LED_2
		 (.oe(tmpOE__Pin_Dice_LED_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Dice_LED_2_net[0:0]}),
		  .io({tmpIO_0__Pin_Dice_LED_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Dice_LED_2_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Dice_LED_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Dice_LED_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Dice_LED_1_net;
	wire [0:0] tmpFB_0__Pin_Dice_LED_1_net;
	wire [0:0] tmpIO_0__Pin_Dice_LED_1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Dice_LED_1_net;
	electrical [0:0] tmpSIOVREF__Pin_Dice_LED_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Dice_LED_1
		 (.oe(tmpOE__Pin_Dice_LED_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Dice_LED_1_net[0:0]}),
		  .io({tmpIO_0__Pin_Dice_LED_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Dice_LED_1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Dice_LED_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Dice_LED_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    UART_v2_50_1 UART_1 (
        ...
        .rx_clk(Net_302),
        .rx_data(Net_303),
        .rx_interrupt(Net_304),
        .tx(Net_305),
        .tx_clk(Net_306),
        .tx_data(Net_307),
        .tx_en(Net_308),
        .tx_interrupt(Net_309));
	...
	cy_psoc3_pins_v1_10
		#(.id("6fd11c38-19c6-4014-853f-06aaf3fb79ef"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__analogBut_net;
	wire [0:0] tmpIO_0__analogBut_net;
	wire [0:0] tmpINTERRUPT_0__analogBut_net;
	electrical [0:0] tmpSIOVREF__analogBut_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("eb653043-62e0-4ac3-a358-4e2ede74f3cb"),
		  ...
		  .input_buffer_sel(2'b00))
		analogBut
		 (.oe(tmpOE__analogBut_net),
		  .y({1'b0}),
		  .fb({Net_249}),
		  .io({tmpIO_0__analogBut_net[0:0]}),
		  .siovref(tmpSIOVREF__analogBut_net),
		  .interrupt({tmpINTERRUPT_0__analogBut_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__analogBut_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__analogY_net;
	wire [0:0] tmpFB_0__analogY_net;
	wire [0:0] tmpIO_0__analogY_net;
	wire [0:0] tmpINTERRUPT_0__analogY_net;
	electrical [0:0] tmpSIOVREF__analogY_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("f2122544-ea7f-45fe-8e70-f7b25cb4b039"),
		  ...
		  .input_buffer_sel(2'b00))
		analogY
		 (.oe(tmpOE__analogY_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__analogY_net[0:0]}),
		  .analog({Net_285}),
		  .io({tmpIO_0__analogY_net[0:0]}),
		  .siovref(tmpSIOVREF__analogY_net),
		  .interrupt({tmpINTERRUPT_0__analogY_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__analogY_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__analogX_net;
	wire [0:0] tmpFB_0__analogX_net;
	wire [0:0] tmpIO_0__analogX_net;
	wire [0:0] tmpINTERRUPT_0__analogX_net;
	electrical [0:0] tmpSIOVREF__analogX_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		analogX
		 (.oe(tmpOE__analogX_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__analogX_net[0:0]}),
		  .analog({Net_284}),
		  .io({tmpIO_0__analogX_net[0:0]}),
		  .siovref(tmpSIOVREF__analogX_net),
		  .interrupt({tmpINTERRUPT_0__analogX_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__analogX_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__but3_net;
	wire [0:0] tmpIO_0__but3_net;
	wire [0:0] tmpINTERRUPT_0__but3_net;
	electrical [0:0] tmpSIOVREF__but3_net;
	...
	cy_psoc3_pins_v1_10
		...
		but3
		 (.oe(tmpOE__but3_net),
		  .y({1'b0}),
		  .fb({Net_242}),
		  .io({tmpIO_0__but3_net[0:0]}),
		  .siovref(tmpSIOVREF__but3_net),
		  .interrupt({tmpINTERRUPT_0__but3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__but3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__but2_net;
	wire [0:0] tmpIO_0__but2_net;
	wire [0:0] tmpINTERRUPT_0__but2_net;
	electrical [0:0] tmpSIOVREF__but2_net;
	...
	cy_psoc3_pins_v1_10
		...
		but2
		 (.oe(tmpOE__but2_net),
		  .y({1'b0}),
		  .fb({Net_237}),
		  .io({tmpIO_0__but2_net[0:0]}),
		  .siovref(tmpSIOVREF__but2_net),
		  .interrupt({tmpINTERRUPT_0__but2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__but2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__but1_net;
	wire [0:0] tmpIO_0__but1_net;
	wire [0:0] tmpINTERRUPT_0__but1_net;
	electrical [0:0] tmpSIOVREF__but1_net;
	...
	cy_psoc3_pins_v1_10
		...
		but1
		 (.oe(tmpOE__but1_net),
		  .y({1'b0}),
		  .fb({Net_145}),
		  .io({tmpIO_0__but1_net[0:0]}),
		  .siovref(tmpSIOVREF__but1_net),
		  .interrupt({tmpINTERRUPT_0__but1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__but1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- AMux analogMUX start -- ***
    // -- Mux A --
    
    cy_psoc3_amux_v1_0 analogMUX(
        .muxin({
            Net_285,
            Net_284
            }),
    ...
    defparam analogMUX.muxin_width = 2;
    defparam analogMUX.init_mux_sel = 2'h0;
    defparam analogMUX.one_active = 0;
    defparam analogMUX.connect_mode = 1;
    
    // -- AMux analogMUX end --

	wire [0:0] tmpOE__Pin_EchoReturn_net;
	wire [0:0] tmpIO_0__Pin_EchoReturn_net;
	electrical [0:0] tmpSIOVREF__Pin_EchoReturn_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("32494378-25b3-43cb-a434-aecc8e418bb1"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_EchoReturn
		 (.oe(tmpOE__Pin_EchoReturn_net),
		  .y({1'b0}),
		  .fb({Net_287}),
		  .io({tmpIO_0__Pin_EchoReturn_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_EchoReturn_net),
		  .interrupt({Net_316}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_EchoReturn_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_EchoTrig_net;
	wire [0:0] tmpFB_0__Pin_EchoTrig_net;
	wire [0:0] tmpIO_0__Pin_EchoTrig_net;
	wire [0:0] tmpINTERRUPT_0__Pin_EchoTrig_net;
	electrical [0:0] tmpSIOVREF__Pin_EchoTrig_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("bccf87c5-6d9b-45ef-a793-4868a55211de"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_EchoTrig
		 (.oe(tmpOE__Pin_EchoTrig_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_EchoTrig_net[0:0]}),
		  .io({tmpIO_0__Pin_EchoTrig_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_EchoTrig_net),
		  .interrupt({tmpINTERRUPT_0__Pin_EchoTrig_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_EchoTrig_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Timer_v2_80_6 Timer_Echo (
        ...
        .tc(Net_433),
        .trigger(1'b1));
    defparam Timer_Echo.CaptureCount = 2;
    defparam Timer_Echo.CaptureCounterEnabled = 0;
    defparam Timer_Echo.DeviceFamily = "PSoC5";
    defparam Timer_Echo.InterruptOnCapture = 0;
    defparam Timer_Echo.InterruptOnTC = 0;
    defparam Timer_Echo.Resolution = 16;
    defparam Timer_Echo.SiliconRevision = "0";
    ...
    Timer_v2_80_8 Timer_Display (
        ...
        .tc(Net_428),
        .trigger(1'b1));
    defparam Timer_Display.CaptureCount = 2;
    defparam Timer_Display.CaptureCounterEnabled = 0;
    defparam Timer_Display.DeviceFamily = "PSoC5";
    defparam Timer_Display.InterruptOnCapture = 0;
    defparam Timer_Display.InterruptOnTC = 1;
    defparam Timer_Display.Resolution = 16;
    defparam Timer_Display.SiliconRevision = "0";
    ...
    UART_v2_50_9 UART_TOESP (
        ...
        .rx_clk(Net_403),
        .rx_data(Net_404),
        .rx_interrupt(Net_405),
        .tx(Net_376),
        .tx_clk(Net_406),
        .tx_data(Net_407),
        .tx_en(Net_408),
        .tx_interrupt(Net_409));
    defparam UART_TOESP.Address1 = 0;
    defparam UART_TOESP.Address2 = 0;
    defparam UART_TOESP.EnIntRXInterrupt = 0;
    defparam UART_TOESP.EnIntTXInterrupt = 0;
    defparam UART_TOESP.FlowControl = 0;
    defparam UART_TOESP.HalfDuplexEn = 0;
    defparam UART_TOESP.HwTXEnSignal = 1;
    defparam UART_TOESP.NumDataBits = 8;
    defparam UART_TOESP.NumStopBits = 1;
    defparam UART_TOESP.ParityType = 0;
    defparam UART_TOESP.RXEnable = 1;
    defparam UART_TOESP.TXEnable = 1;
	...
	wire [0:0] tmpOE__Pin_OSZ2_net;
	wire [0:0] tmpFB_0__Pin_OSZ2_net;
	wire [0:0] tmpIO_0__Pin_OSZ2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_OSZ2_net;
	electrical [0:0] tmpSIOVREF__Pin_OSZ2_net;

	cy_psoc3_pins_v1_10
		#(.id("7f58d216-af33-4d86-b2ea-eb63d483dbf7"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_OSZ2
		 (.oe(tmpOE__Pin_OSZ2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_OSZ2_net[0:0]}),
		  .io({tmpIO_0__Pin_OSZ2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_OSZ2_net),
		  .interrupt({tmpINTERRUPT_0__Pin_OSZ2_net[0:0]}),
		  .annotation({Net_637}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_OSZ2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("c80138ad-9fbe-4335-b1b3-9d3f75193295"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("4000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("084938d9-e7b6-4557-9d04-d25d9b2adc59"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_OSZ1_net;
	wire [0:0] tmpFB_0__Pin_OSZ1_net;
	wire [0:0] tmpIO_0__Pin_OSZ1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_OSZ1_net;
	electrical [0:0] tmpSIOVREF__Pin_OSZ1_net;

	cy_psoc3_pins_v1_10
		#(.id("8d6d2e94-c109-49fd-b336-072b8083cdcf"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_OSZ1
		 (.oe(tmpOE__Pin_OSZ1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_OSZ1_net[0:0]}),
		  .io({tmpIO_0__Pin_OSZ1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_OSZ1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_OSZ1_net[0:0]}),
		  .annotation({Net_633}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_OSZ1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_OSZ1_LED_net;
	wire [0:0] tmpFB_0__Pin_OSZ1_LED_net;
	wire [0:0] tmpIO_0__Pin_OSZ1_LED_net;
	wire [0:0] tmpINTERRUPT_0__Pin_OSZ1_LED_net;
	electrical [0:0] tmpSIOVREF__Pin_OSZ1_LED_net;

	cy_psoc3_pins_v1_10
		#(.id("fbfee34f-911e-48cb-b00c-fd33ace9f637"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_OSZ1_LED
		 (.oe(tmpOE__Pin_OSZ1_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_OSZ1_LED_net[0:0]}),
		  .io({tmpIO_0__Pin_OSZ1_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_OSZ1_LED_net),
		  .interrupt({tmpINTERRUPT_0__Pin_OSZ1_LED_net[0:0]}),
		  .annotation({Net_641}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_OSZ1_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_OSZ2_LED_net;
	wire [0:0] tmpFB_0__Pin_OSZ2_LED_net;
	wire [0:0] tmpIO_0__Pin_OSZ2_LED_net;
	wire [0:0] tmpINTERRUPT_0__Pin_OSZ2_LED_net;
	electrical [0:0] tmpSIOVREF__Pin_OSZ2_LED_net;

	cy_psoc3_pins_v1_10
		#(.id("e9480e02-9f33-41d1-b78e-2d23bcd31743"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_OSZ2_LED
		 (.oe(tmpOE__Pin_OSZ2_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_OSZ2_LED_net[0:0]}),
		  .io({tmpIO_0__Pin_OSZ2_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_OSZ2_LED_net),
		  .interrupt({tmpINTERRUPT_0__Pin_OSZ2_LED_net[0:0]}),
		  .annotation({Net_642}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_OSZ2_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

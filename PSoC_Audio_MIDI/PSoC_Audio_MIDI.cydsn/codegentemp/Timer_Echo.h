...
#define Timer_Echo_InterruptOnCaptureCount    0u
#define Timer_Echo_RunModeUsed                0u
#define Timer_Echo_ControlRegRemoved          1u
...
#define Timer_Echo_INIT_PERIOD             999u
#define Timer_Echo_INIT_CAPTURE_MODE       ((uint8)((uint8)0u << Timer_Echo_CTRL_CAP_MODE_SHIFT))
#define Timer_Echo_INIT_TRIGGER_MODE       ((uint8)((uint8)0u << Timer_Echo_CTRL_TRIG_MODE_SHIFT))
#if (Timer_Echo_UsingFixedFunction)
    #define Timer_Echo_INIT_INTERRUPT_MODE (((uint8)((uint8)0u << Timer_Echo_STATUS_TC_INT_MASK_SHIFT)) | \
                                                  ((uint8)((uint8)0 << Timer_Echo_STATUS_CAPTURE_INT_MASK_SHIFT)))
#else
    #define Timer_Echo_INIT_INTERRUPT_MODE (((uint8)((uint8)0u << Timer_Echo_STATUS_TC_INT_MASK_SHIFT)) | \
                                                 ((uint8)((uint8)0 << Timer_Echo_STATUS_CAPTURE_INT_MASK_SHIFT)) | \

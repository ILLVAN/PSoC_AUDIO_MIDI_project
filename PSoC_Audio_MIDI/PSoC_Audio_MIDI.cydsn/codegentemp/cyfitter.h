...
#define but1_isr_neg__INTC_MASK 0x01u
#define but1_isr_neg__INTC_NUMBER 0u
#define but1_isr_neg__INTC_PRIOR_NUM 7u
#define but1_isr_neg__INTC_PRIOR_REG CYREG_NVIC_PRI_0
...
#define but1_isr_pos__INTC_MASK 0x02u
#define but1_isr_pos__INTC_NUMBER 1u
#define but1_isr_pos__INTC_PRIOR_NUM 7u
#define but1_isr_pos__INTC_PRIOR_REG CYREG_NVIC_PRI_1
...
#define but2_isr_neg__INTC_MASK 0x04u
#define but2_isr_neg__INTC_NUMBER 2u
#define but2_isr_neg__INTC_PRIOR_NUM 7u
#define but2_isr_neg__INTC_PRIOR_REG CYREG_NVIC_PRI_2
...
#define but2_isr_pos__INTC_MASK 0x08u
#define but2_isr_pos__INTC_NUMBER 3u
#define but2_isr_pos__INTC_PRIOR_NUM 7u
#define but2_isr_pos__INTC_PRIOR_REG CYREG_NVIC_PRI_3
...
#define but3_isr_neg__INTC_MASK 0x10u
#define but3_isr_neg__INTC_NUMBER 4u
#define but3_isr_neg__INTC_PRIOR_NUM 7u
#define but3_isr_neg__INTC_PRIOR_REG CYREG_NVIC_PRI_4
...
#define but3_isr_pos__INTC_MASK 0x20u
#define but3_isr_pos__INTC_NUMBER 5u
#define but3_isr_pos__INTC_PRIOR_NUM 7u
#define but3_isr_pos__INTC_PRIOR_REG CYREG_NVIC_PRI_5
...
/* analogX */
#define analogX__0__INTTYPE CYREG_PICU2_INTTYPE7
#define analogX__0__MASK 0x80u
#define analogX__0__PC CYREG_PRT2_PC7
#define analogX__0__PORT 2u
#define analogX__0__SHIFT 7u
#define analogX__AG CYREG_PRT2_AG
#define analogX__AMUX CYREG_PRT2_AMUX
#define analogX__BIE CYREG_PRT2_BIE
#define analogX__BIT_MASK CYREG_PRT2_BIT_MASK
#define analogX__BYP CYREG_PRT2_BYP
#define analogX__CTL CYREG_PRT2_CTL
#define analogX__DM0 CYREG_PRT2_DM0
#define analogX__DM1 CYREG_PRT2_DM1
#define analogX__DM2 CYREG_PRT2_DM2
#define analogX__DR CYREG_PRT2_DR
#define analogX__INP_DIS CYREG_PRT2_INP_DIS
#define analogX__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define analogX__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define analogX__LCD_EN CYREG_PRT2_LCD_EN
#define analogX__MASK 0x80u
#define analogX__PORT 2u
#define analogX__PRT CYREG_PRT2_PRT
#define analogX__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define analogX__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define analogX__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define analogX__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define analogX__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define analogX__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define analogX__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define analogX__PS CYREG_PRT2_PS
#define analogX__SHIFT 7u
#define analogX__SLW CYREG_PRT2_SLW

/* analogY */
#define analogY__0__INTTYPE CYREG_PICU2_INTTYPE1
#define analogY__0__MASK 0x02u
#define analogY__0__PC CYREG_PRT2_PC1
#define analogY__0__PORT 2u
#define analogY__0__SHIFT 1u
#define analogY__AG CYREG_PRT2_AG
#define analogY__AMUX CYREG_PRT2_AMUX
#define analogY__BIE CYREG_PRT2_BIE
#define analogY__BIT_MASK CYREG_PRT2_BIT_MASK
#define analogY__BYP CYREG_PRT2_BYP
#define analogY__CTL CYREG_PRT2_CTL
#define analogY__DM0 CYREG_PRT2_DM0
#define analogY__DM1 CYREG_PRT2_DM1
#define analogY__DM2 CYREG_PRT2_DM2
#define analogY__DR CYREG_PRT2_DR
#define analogY__INP_DIS CYREG_PRT2_INP_DIS
#define analogY__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define analogY__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define analogY__LCD_EN CYREG_PRT2_LCD_EN
#define analogY__MASK 0x02u
#define analogY__PORT 2u
#define analogY__PRT CYREG_PRT2_PRT
#define analogY__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define analogY__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define analogY__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define analogY__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define analogY__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define analogY__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define analogY__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define analogY__PS CYREG_PRT2_PS
#define analogY__SHIFT 1u
#define analogY__SLW CYREG_PRT2_SLW
...
/* Clock_Mode */
#define Clock_Mode__CFG0 CYREG_CLKDIST_DCFG3_CFG0
#define Clock_Mode__CFG1 CYREG_CLKDIST_DCFG3_CFG1
#define Clock_Mode__CFG2 CYREG_CLKDIST_DCFG3_CFG2
#define Clock_Mode__CFG2_SRC_SEL_MASK 0x07u
#define Clock_Mode__INDEX 0x03u
#define Clock_Mode__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define Clock_Mode__PM_ACT_MSK 0x08u
#define Clock_Mode__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define Clock_Mode__PM_STBY_MSK 0x08u

/* Pin_Dice_1 */
#define Pin_Dice_1__0__INTTYPE CYREG_PICU1_INTTYPE7
#define Pin_Dice_1__0__MASK 0x80u
#define Pin_Dice_1__0__PC CYREG_PRT1_PC7
#define Pin_Dice_1__0__PORT 1u
#define Pin_Dice_1__0__SHIFT 7u
#define Pin_Dice_1__AG CYREG_PRT1_AG
#define Pin_Dice_1__AMUX CYREG_PRT1_AMUX
#define Pin_Dice_1__BIE CYREG_PRT1_BIE
#define Pin_Dice_1__BIT_MASK CYREG_PRT1_BIT_MASK
#define Pin_Dice_1__BYP CYREG_PRT1_BYP
#define Pin_Dice_1__CTL CYREG_PRT1_CTL
#define Pin_Dice_1__DM0 CYREG_PRT1_DM0
#define Pin_Dice_1__DM1 CYREG_PRT1_DM1
#define Pin_Dice_1__DM2 CYREG_PRT1_DM2
#define Pin_Dice_1__DR CYREG_PRT1_DR
#define Pin_Dice_1__INP_DIS CYREG_PRT1_INP_DIS
#define Pin_Dice_1__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define Pin_Dice_1__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define Pin_Dice_1__LCD_EN CYREG_PRT1_LCD_EN
#define Pin_Dice_1__MASK 0x80u
#define Pin_Dice_1__PORT 1u
#define Pin_Dice_1__PRT CYREG_PRT1_PRT
#define Pin_Dice_1__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define Pin_Dice_1__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define Pin_Dice_1__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define Pin_Dice_1__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define Pin_Dice_1__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define Pin_Dice_1__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define Pin_Dice_1__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define Pin_Dice_1__PS CYREG_PRT1_PS
#define Pin_Dice_1__SHIFT 7u
#define Pin_Dice_1__SLW CYREG_PRT1_SLW

/* Pin_Dice_2 */
#define Pin_Dice_2__0__INTTYPE CYREG_PICU1_INTTYPE5
#define Pin_Dice_2__0__MASK 0x20u
#define Pin_Dice_2__0__PC CYREG_PRT1_PC5
#define Pin_Dice_2__0__PORT 1u
#define Pin_Dice_2__0__SHIFT 5u
#define Pin_Dice_2__AG CYREG_PRT1_AG
#define Pin_Dice_2__AMUX CYREG_PRT1_AMUX
#define Pin_Dice_2__BIE CYREG_PRT1_BIE
#define Pin_Dice_2__BIT_MASK CYREG_PRT1_BIT_MASK
#define Pin_Dice_2__BYP CYREG_PRT1_BYP
#define Pin_Dice_2__CTL CYREG_PRT1_CTL
#define Pin_Dice_2__DM0 CYREG_PRT1_DM0
#define Pin_Dice_2__DM1 CYREG_PRT1_DM1
#define Pin_Dice_2__DM2 CYREG_PRT1_DM2
#define Pin_Dice_2__DR CYREG_PRT1_DR
#define Pin_Dice_2__INP_DIS CYREG_PRT1_INP_DIS
#define Pin_Dice_2__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define Pin_Dice_2__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define Pin_Dice_2__LCD_EN CYREG_PRT1_LCD_EN
#define Pin_Dice_2__MASK 0x20u
#define Pin_Dice_2__PORT 1u
#define Pin_Dice_2__PRT CYREG_PRT1_PRT
#define Pin_Dice_2__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define Pin_Dice_2__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define Pin_Dice_2__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define Pin_Dice_2__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define Pin_Dice_2__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define Pin_Dice_2__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define Pin_Dice_2__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define Pin_Dice_2__PS CYREG_PRT1_PS
#define Pin_Dice_2__SHIFT 5u
#define Pin_Dice_2__SLW CYREG_PRT1_SLW
...
/* analogPress */
#define analogPress__0__INTTYPE CYREG_PICU0_INTTYPE0
#define analogPress__0__MASK 0x01u
#define analogPress__0__PC CYREG_PRT0_PC0
#define analogPress__0__PORT 0u
#define analogPress__0__SHIFT 0u
#define analogPress__AG CYREG_PRT0_AG
#define analogPress__AMUX CYREG_PRT0_AMUX
#define analogPress__BIE CYREG_PRT0_BIE
#define analogPress__BIT_MASK CYREG_PRT0_BIT_MASK
#define analogPress__BYP CYREG_PRT0_BYP
#define analogPress__CTL CYREG_PRT0_CTL
#define analogPress__DM0 CYREG_PRT0_DM0
#define analogPress__DM1 CYREG_PRT0_DM1
#define analogPress__DM2 CYREG_PRT0_DM2
#define analogPress__DR CYREG_PRT0_DR
#define analogPress__INP_DIS CYREG_PRT0_INP_DIS
#define analogPress__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define analogPress__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define analogPress__LCD_EN CYREG_PRT0_LCD_EN
#define analogPress__MASK 0x01u
#define analogPress__PORT 0u
#define analogPress__PRT CYREG_PRT0_PRT
#define analogPress__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define analogPress__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define analogPress__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define analogPress__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define analogPress__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define analogPress__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define analogPress__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define analogPress__PS CYREG_PRT0_PS
#define analogPress__SHIFT 0u
#define analogPress__SLW CYREG_PRT0_SLW
...
/* Pin_Dice_LED_1 */
#define Pin_Dice_LED_1__0__INTTYPE CYREG_PICU1_INTTYPE6
#define Pin_Dice_LED_1__0__MASK 0x40u
#define Pin_Dice_LED_1__0__PC CYREG_PRT1_PC6
#define Pin_Dice_LED_1__0__PORT 1u
#define Pin_Dice_LED_1__0__SHIFT 6u
#define Pin_Dice_LED_1__AG CYREG_PRT1_AG
#define Pin_Dice_LED_1__AMUX CYREG_PRT1_AMUX
#define Pin_Dice_LED_1__BIE CYREG_PRT1_BIE
#define Pin_Dice_LED_1__BIT_MASK CYREG_PRT1_BIT_MASK
#define Pin_Dice_LED_1__BYP CYREG_PRT1_BYP
#define Pin_Dice_LED_1__CTL CYREG_PRT1_CTL
#define Pin_Dice_LED_1__DM0 CYREG_PRT1_DM0
#define Pin_Dice_LED_1__DM1 CYREG_PRT1_DM1
#define Pin_Dice_LED_1__DM2 CYREG_PRT1_DM2
#define Pin_Dice_LED_1__DR CYREG_PRT1_DR
#define Pin_Dice_LED_1__INP_DIS CYREG_PRT1_INP_DIS
#define Pin_Dice_LED_1__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define Pin_Dice_LED_1__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define Pin_Dice_LED_1__LCD_EN CYREG_PRT1_LCD_EN
#define Pin_Dice_LED_1__MASK 0x40u
#define Pin_Dice_LED_1__PORT 1u
#define Pin_Dice_LED_1__PRT CYREG_PRT1_PRT
#define Pin_Dice_LED_1__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define Pin_Dice_LED_1__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define Pin_Dice_LED_1__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define Pin_Dice_LED_1__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define Pin_Dice_LED_1__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define Pin_Dice_LED_1__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define Pin_Dice_LED_1__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define Pin_Dice_LED_1__PS CYREG_PRT1_PS
#define Pin_Dice_LED_1__SHIFT 6u
#define Pin_Dice_LED_1__SLW CYREG_PRT1_SLW

/* Pin_Dice_LED_2 */
#define Pin_Dice_LED_2__0__INTTYPE CYREG_PICU1_INTTYPE4
#define Pin_Dice_LED_2__0__MASK 0x10u
#define Pin_Dice_LED_2__0__PC CYREG_PRT1_PC4
#define Pin_Dice_LED_2__0__PORT 1u
#define Pin_Dice_LED_2__0__SHIFT 4u
#define Pin_Dice_LED_2__AG CYREG_PRT1_AG
#define Pin_Dice_LED_2__AMUX CYREG_PRT1_AMUX
#define Pin_Dice_LED_2__BIE CYREG_PRT1_BIE
#define Pin_Dice_LED_2__BIT_MASK CYREG_PRT1_BIT_MASK
#define Pin_Dice_LED_2__BYP CYREG_PRT1_BYP
#define Pin_Dice_LED_2__CTL CYREG_PRT1_CTL
#define Pin_Dice_LED_2__DM0 CYREG_PRT1_DM0
#define Pin_Dice_LED_2__DM1 CYREG_PRT1_DM1
#define Pin_Dice_LED_2__DM2 CYREG_PRT1_DM2
#define Pin_Dice_LED_2__DR CYREG_PRT1_DR
#define Pin_Dice_LED_2__INP_DIS CYREG_PRT1_INP_DIS
#define Pin_Dice_LED_2__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define Pin_Dice_LED_2__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define Pin_Dice_LED_2__LCD_EN CYREG_PRT1_LCD_EN
#define Pin_Dice_LED_2__MASK 0x10u
#define Pin_Dice_LED_2__PORT 1u
#define Pin_Dice_LED_2__PRT CYREG_PRT1_PRT
#define Pin_Dice_LED_2__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define Pin_Dice_LED_2__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define Pin_Dice_LED_2__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define Pin_Dice_LED_2__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define Pin_Dice_LED_2__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define Pin_Dice_LED_2__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define Pin_Dice_LED_2__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define Pin_Dice_LED_2__PS CYREG_PRT1_PS
#define Pin_Dice_LED_2__SHIFT 4u
#define Pin_Dice_LED_2__SLW CYREG_PRT1_SLW

/* debouncerClock */
#define debouncerClock__CFG0 CYREG_CLKDIST_DCFG2_CFG0
#define debouncerClock__CFG1 CYREG_CLKDIST_DCFG2_CFG1
#define debouncerClock__CFG2 CYREG_CLKDIST_DCFG2_CFG2
#define debouncerClock__CFG2_SRC_SEL_MASK 0x07u
#define debouncerClock__INDEX 0x02u
#define debouncerClock__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define debouncerClock__PM_ACT_MSK 0x04u
#define debouncerClock__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define debouncerClock__PM_STBY_MSK 0x04u

...
#define but1_isr_neg__INTC_MASK 0x08u
#define but1_isr_neg__INTC_NUMBER 3u
#define but1_isr_neg__INTC_PRIOR_NUM 5u
#define but1_isr_neg__INTC_PRIOR_REG CYREG_NVIC_PRI_3
...
#define but1_isr_pos__INTC_MASK 0x10u
#define but1_isr_pos__INTC_NUMBER 4u
#define but1_isr_pos__INTC_PRIOR_NUM 5u
#define but1_isr_pos__INTC_PRIOR_REG CYREG_NVIC_PRI_4
...
#define but2_isr_neg__INTC_MASK 0x20u
#define but2_isr_neg__INTC_NUMBER 5u
#define but2_isr_neg__INTC_PRIOR_NUM 5u
#define but2_isr_neg__INTC_PRIOR_REG CYREG_NVIC_PRI_5
...
#define but2_isr_pos__INTC_MASK 0x40u
#define but2_isr_pos__INTC_NUMBER 6u
#define but2_isr_pos__INTC_PRIOR_NUM 5u
#define but2_isr_pos__INTC_PRIOR_REG CYREG_NVIC_PRI_6
...
#define but3_isr_neg__INTC_MASK 0x100u
#define but3_isr_neg__INTC_NUMBER 8u
#define but3_isr_neg__INTC_PRIOR_NUM 5u
#define but3_isr_neg__INTC_PRIOR_REG CYREG_NVIC_PRI_8
...
#define but3_isr_pos__INTC_MASK 0x200u
#define but3_isr_pos__INTC_NUMBER 9u
#define but3_isr_pos__INTC_PRIOR_NUM 5u
#define but3_isr_pos__INTC_PRIOR_REG CYREG_NVIC_PRI_9
...
#define ADC_isr__INTC_PRIOR_NUM 5u
...
/* I2COLED */
#define I2COLED_bI2C_UDB_Master_ClkGen_u0__16BIT_A0_REG CYREG_B0_UDB01_02_A0
#define I2COLED_bI2C_UDB_Master_ClkGen_u0__16BIT_A1_REG CYREG_B0_UDB01_02_A1
#define I2COLED_bI2C_UDB_Master_ClkGen_u0__16BIT_D0_REG CYREG_B0_UDB01_02_D0
#define I2COLED_bI2C_UDB_Master_ClkGen_u0__16BIT_D1_REG CYREG_B0_UDB01_02_D1
#define I2COLED_bI2C_UDB_Master_ClkGen_u0__16BIT_DP_AUX_CTL_REG CYREG_B0_UDB01_02_ACTL
#define I2COLED_bI2C_UDB_Master_ClkGen_u0__16BIT_F0_REG CYREG_B0_UDB01_02_F0
#define I2COLED_bI2C_UDB_Master_ClkGen_u0__16BIT_F1_REG CYREG_B0_UDB01_02_F1
#define I2COLED_bI2C_UDB_Master_ClkGen_u0__A0_A1_REG CYREG_B0_UDB01_A0_A1
#define I2COLED_bI2C_UDB_Master_ClkGen_u0__A0_REG CYREG_B0_UDB01_A0
#define I2COLED_bI2C_UDB_Master_ClkGen_u0__A1_REG CYREG_B0_UDB01_A1
#define I2COLED_bI2C_UDB_Master_ClkGen_u0__D0_D1_REG CYREG_B0_UDB01_D0_D1
#define I2COLED_bI2C_UDB_Master_ClkGen_u0__D0_REG CYREG_B0_UDB01_D0
#define I2COLED_bI2C_UDB_Master_ClkGen_u0__D1_REG CYREG_B0_UDB01_D1
#define I2COLED_bI2C_UDB_Master_ClkGen_u0__DP_AUX_CTL_REG CYREG_B0_UDB01_ACTL
#define I2COLED_bI2C_UDB_Master_ClkGen_u0__F0_F1_REG CYREG_B0_UDB01_F0_F1
#define I2COLED_bI2C_UDB_Master_ClkGen_u0__F0_REG CYREG_B0_UDB01_F0
#define I2COLED_bI2C_UDB_Master_ClkGen_u0__F1_REG CYREG_B0_UDB01_F1
#define I2COLED_bI2C_UDB_Shifter_u0__16BIT_A0_REG CYREG_B0_UDB03_04_A0
#define I2COLED_bI2C_UDB_Shifter_u0__16BIT_A1_REG CYREG_B0_UDB03_04_A1
#define I2COLED_bI2C_UDB_Shifter_u0__16BIT_D0_REG CYREG_B0_UDB03_04_D0
#define I2COLED_bI2C_UDB_Shifter_u0__16BIT_D1_REG CYREG_B0_UDB03_04_D1
#define I2COLED_bI2C_UDB_Shifter_u0__16BIT_DP_AUX_CTL_REG CYREG_B0_UDB03_04_ACTL
#define I2COLED_bI2C_UDB_Shifter_u0__16BIT_F0_REG CYREG_B0_UDB03_04_F0
#define I2COLED_bI2C_UDB_Shifter_u0__16BIT_F1_REG CYREG_B0_UDB03_04_F1
#define I2COLED_bI2C_UDB_Shifter_u0__A0_A1_REG CYREG_B0_UDB03_A0_A1
#define I2COLED_bI2C_UDB_Shifter_u0__A0_REG CYREG_B0_UDB03_A0
#define I2COLED_bI2C_UDB_Shifter_u0__A1_REG CYREG_B0_UDB03_A1
#define I2COLED_bI2C_UDB_Shifter_u0__D0_D1_REG CYREG_B0_UDB03_D0_D1
#define I2COLED_bI2C_UDB_Shifter_u0__D0_REG CYREG_B0_UDB03_D0
#define I2COLED_bI2C_UDB_Shifter_u0__D1_REG CYREG_B0_UDB03_D1
#define I2COLED_bI2C_UDB_Shifter_u0__DP_AUX_CTL_REG CYREG_B0_UDB03_ACTL
#define I2COLED_bI2C_UDB_Shifter_u0__F0_F1_REG CYREG_B0_UDB03_F0_F1
#define I2COLED_bI2C_UDB_Shifter_u0__F0_REG CYREG_B0_UDB03_F0
#define I2COLED_bI2C_UDB_Shifter_u0__F1_REG CYREG_B0_UDB03_F1
#define I2COLED_bI2C_UDB_StsReg__0__MASK 0x01u
#define I2COLED_bI2C_UDB_StsReg__0__POS 0
#define I2COLED_bI2C_UDB_StsReg__1__MASK 0x02u
#define I2COLED_bI2C_UDB_StsReg__1__POS 1
#define I2COLED_bI2C_UDB_StsReg__16BIT_STATUS_AUX_CTL_REG CYREG_B0_UDB06_07_ACTL
#define I2COLED_bI2C_UDB_StsReg__16BIT_STATUS_REG CYREG_B0_UDB06_07_ST
#define I2COLED_bI2C_UDB_StsReg__2__MASK 0x04u
#define I2COLED_bI2C_UDB_StsReg__2__POS 2
#define I2COLED_bI2C_UDB_StsReg__3__MASK 0x08u
#define I2COLED_bI2C_UDB_StsReg__3__POS 3
#define I2COLED_bI2C_UDB_StsReg__4__MASK 0x10u
#define I2COLED_bI2C_UDB_StsReg__4__POS 4
#define I2COLED_bI2C_UDB_StsReg__5__MASK 0x20u
#define I2COLED_bI2C_UDB_StsReg__5__POS 5
#define I2COLED_bI2C_UDB_StsReg__MASK 0x3Fu
#define I2COLED_bI2C_UDB_StsReg__MASK_REG CYREG_B0_UDB06_MSK
#define I2COLED_bI2C_UDB_StsReg__STATUS_AUX_CTL_REG CYREG_B0_UDB06_ACTL
#define I2COLED_bI2C_UDB_StsReg__STATUS_REG CYREG_B0_UDB06_ST
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__1__MASK 0x02u
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__1__POS 1
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__16BIT_CONTROL_AUX_CTL_REG CYREG_B0_UDB12_13_ACTL
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__16BIT_CONTROL_CONTROL_REG CYREG_B0_UDB12_13_CTL
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__16BIT_CONTROL_COUNT_REG CYREG_B0_UDB12_13_CTL
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__16BIT_COUNT_CONTROL_REG CYREG_B0_UDB12_13_CTL
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__16BIT_COUNT_COUNT_REG CYREG_B0_UDB12_13_CTL
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__16BIT_MASK_MASK_REG CYREG_B0_UDB12_13_MSK
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__16BIT_MASK_PERIOD_REG CYREG_B0_UDB12_13_MSK
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__16BIT_PERIOD_MASK_REG CYREG_B0_UDB12_13_MSK
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__16BIT_PERIOD_PERIOD_REG CYREG_B0_UDB12_13_MSK
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__2__MASK 0x04u
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__2__POS 2
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__4__MASK 0x10u
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__4__POS 4
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__5__MASK 0x20u
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__5__POS 5
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__6__MASK 0x40u
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__6__POS 6
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__7__MASK 0x80u
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__7__POS 7
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__CONTROL_AUX_CTL_REG CYREG_B0_UDB12_ACTL
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__CONTROL_REG CYREG_B0_UDB12_CTL
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__CONTROL_ST_REG CYREG_B0_UDB12_ST_CTL
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__COUNT_REG CYREG_B0_UDB12_CTL
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__COUNT_ST_REG CYREG_B0_UDB12_ST_CTL
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__MASK 0xF6u
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__MASK_CTL_AUX_CTL_REG CYREG_B0_UDB12_MSK_ACTL
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__PER_CTL_AUX_CTL_REG CYREG_B0_UDB12_MSK_ACTL
#define I2COLED_bI2C_UDB_SyncCtl_CtrlReg__PERIOD_REG CYREG_B0_UDB12_MSK
#define I2COLED_I2C_IRQ__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define I2COLED_I2C_IRQ__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define I2COLED_I2C_IRQ__INTC_MASK 0x01u
#define I2COLED_I2C_IRQ__INTC_NUMBER 0u
#define I2COLED_I2C_IRQ__INTC_PRIOR_NUM 7u
#define I2COLED_I2C_IRQ__INTC_PRIOR_REG CYREG_NVIC_PRI_0
...
/* Pin_OSZ1 */
#define Pin_OSZ1__0__INTTYPE CYREG_PICU0_INTTYPE6
#define Pin_OSZ1__0__MASK 0x40u
#define Pin_OSZ1__0__PC CYREG_PRT0_PC6
#define Pin_OSZ1__0__PORT 0u
#define Pin_OSZ1__0__SHIFT 6u
#define Pin_OSZ1__AG CYREG_PRT0_AG
#define Pin_OSZ1__AMUX CYREG_PRT0_AMUX
#define Pin_OSZ1__BIE CYREG_PRT0_BIE
#define Pin_OSZ1__BIT_MASK CYREG_PRT0_BIT_MASK
#define Pin_OSZ1__BYP CYREG_PRT0_BYP
#define Pin_OSZ1__CTL CYREG_PRT0_CTL
#define Pin_OSZ1__DM0 CYREG_PRT0_DM0
#define Pin_OSZ1__DM1 CYREG_PRT0_DM1
#define Pin_OSZ1__DM2 CYREG_PRT0_DM2
#define Pin_OSZ1__DR CYREG_PRT0_DR
#define Pin_OSZ1__INP_DIS CYREG_PRT0_INP_DIS
#define Pin_OSZ1__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define Pin_OSZ1__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define Pin_OSZ1__LCD_EN CYREG_PRT0_LCD_EN
#define Pin_OSZ1__MASK 0x40u
#define Pin_OSZ1__PORT 0u
#define Pin_OSZ1__PRT CYREG_PRT0_PRT
#define Pin_OSZ1__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define Pin_OSZ1__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define Pin_OSZ1__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define Pin_OSZ1__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define Pin_OSZ1__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define Pin_OSZ1__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define Pin_OSZ1__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define Pin_OSZ1__PS CYREG_PRT0_PS
#define Pin_OSZ1__SHIFT 6u
#define Pin_OSZ1__SLW CYREG_PRT0_SLW
#define Pin_OSZ1_LED__0__INTTYPE CYREG_PICU0_INTTYPE4
#define Pin_OSZ1_LED__0__MASK 0x10u
#define Pin_OSZ1_LED__0__PC CYREG_PRT0_PC4
#define Pin_OSZ1_LED__0__PORT 0u
#define Pin_OSZ1_LED__0__SHIFT 4u
#define Pin_OSZ1_LED__AG CYREG_PRT0_AG
#define Pin_OSZ1_LED__AMUX CYREG_PRT0_AMUX
#define Pin_OSZ1_LED__BIE CYREG_PRT0_BIE
#define Pin_OSZ1_LED__BIT_MASK CYREG_PRT0_BIT_MASK
#define Pin_OSZ1_LED__BYP CYREG_PRT0_BYP
#define Pin_OSZ1_LED__CTL CYREG_PRT0_CTL
#define Pin_OSZ1_LED__DM0 CYREG_PRT0_DM0
#define Pin_OSZ1_LED__DM1 CYREG_PRT0_DM1
#define Pin_OSZ1_LED__DM2 CYREG_PRT0_DM2
#define Pin_OSZ1_LED__DR CYREG_PRT0_DR
#define Pin_OSZ1_LED__INP_DIS CYREG_PRT0_INP_DIS
#define Pin_OSZ1_LED__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define Pin_OSZ1_LED__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define Pin_OSZ1_LED__LCD_EN CYREG_PRT0_LCD_EN
#define Pin_OSZ1_LED__MASK 0x10u
#define Pin_OSZ1_LED__PORT 0u
#define Pin_OSZ1_LED__PRT CYREG_PRT0_PRT
#define Pin_OSZ1_LED__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define Pin_OSZ1_LED__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define Pin_OSZ1_LED__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define Pin_OSZ1_LED__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define Pin_OSZ1_LED__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define Pin_OSZ1_LED__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define Pin_OSZ1_LED__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define Pin_OSZ1_LED__PS CYREG_PRT0_PS
#define Pin_OSZ1_LED__SHIFT 4u
#define Pin_OSZ1_LED__SLW CYREG_PRT0_SLW

/* Pin_OSZ2 */
#define Pin_OSZ2__0__INTTYPE CYREG_PICU0_INTTYPE7
#define Pin_OSZ2__0__MASK 0x80u
#define Pin_OSZ2__0__PC CYREG_PRT0_PC7
#define Pin_OSZ2__0__PORT 0u
#define Pin_OSZ2__0__SHIFT 7u
#define Pin_OSZ2__AG CYREG_PRT0_AG
#define Pin_OSZ2__AMUX CYREG_PRT0_AMUX
#define Pin_OSZ2__BIE CYREG_PRT0_BIE
#define Pin_OSZ2__BIT_MASK CYREG_PRT0_BIT_MASK
#define Pin_OSZ2__BYP CYREG_PRT0_BYP
#define Pin_OSZ2__CTL CYREG_PRT0_CTL
#define Pin_OSZ2__DM0 CYREG_PRT0_DM0
#define Pin_OSZ2__DM1 CYREG_PRT0_DM1
#define Pin_OSZ2__DM2 CYREG_PRT0_DM2
#define Pin_OSZ2__DR CYREG_PRT0_DR
#define Pin_OSZ2__INP_DIS CYREG_PRT0_INP_DIS
#define Pin_OSZ2__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define Pin_OSZ2__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define Pin_OSZ2__LCD_EN CYREG_PRT0_LCD_EN
#define Pin_OSZ2__MASK 0x80u
#define Pin_OSZ2__PORT 0u
#define Pin_OSZ2__PRT CYREG_PRT0_PRT
#define Pin_OSZ2__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define Pin_OSZ2__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define Pin_OSZ2__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define Pin_OSZ2__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define Pin_OSZ2__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define Pin_OSZ2__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define Pin_OSZ2__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define Pin_OSZ2__PS CYREG_PRT0_PS
#define Pin_OSZ2__SHIFT 7u
#define Pin_OSZ2__SLW CYREG_PRT0_SLW
#define Pin_OSZ2_LED__0__INTTYPE CYREG_PICU0_INTTYPE5
#define Pin_OSZ2_LED__0__MASK 0x20u
#define Pin_OSZ2_LED__0__PC CYREG_PRT0_PC5
#define Pin_OSZ2_LED__0__PORT 0u
#define Pin_OSZ2_LED__0__SHIFT 5u
#define Pin_OSZ2_LED__AG CYREG_PRT0_AG
#define Pin_OSZ2_LED__AMUX CYREG_PRT0_AMUX
#define Pin_OSZ2_LED__BIE CYREG_PRT0_BIE
#define Pin_OSZ2_LED__BIT_MASK CYREG_PRT0_BIT_MASK
#define Pin_OSZ2_LED__BYP CYREG_PRT0_BYP
#define Pin_OSZ2_LED__CTL CYREG_PRT0_CTL
#define Pin_OSZ2_LED__DM0 CYREG_PRT0_DM0
#define Pin_OSZ2_LED__DM1 CYREG_PRT0_DM1
#define Pin_OSZ2_LED__DM2 CYREG_PRT0_DM2
#define Pin_OSZ2_LED__DR CYREG_PRT0_DR
#define Pin_OSZ2_LED__INP_DIS CYREG_PRT0_INP_DIS
#define Pin_OSZ2_LED__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define Pin_OSZ2_LED__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define Pin_OSZ2_LED__LCD_EN CYREG_PRT0_LCD_EN
#define Pin_OSZ2_LED__MASK 0x20u
#define Pin_OSZ2_LED__PORT 0u
#define Pin_OSZ2_LED__PRT CYREG_PRT0_PRT
#define Pin_OSZ2_LED__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define Pin_OSZ2_LED__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define Pin_OSZ2_LED__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define Pin_OSZ2_LED__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define Pin_OSZ2_LED__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define Pin_OSZ2_LED__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define Pin_OSZ2_LED__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define Pin_OSZ2_LED__PS CYREG_PRT0_PS
#define Pin_OSZ2_LED__SHIFT 5u
#define Pin_OSZ2_LED__SLW CYREG_PRT0_SLW
...
#define analogADC_IRQ__INTC_MASK 0x02u
#define analogADC_IRQ__INTC_NUMBER 1u
#define analogADC_IRQ__INTC_PRIOR_NUM 5u
#define analogADC_IRQ__INTC_PRIOR_REG CYREG_NVIC_PRI_1
...
#define analogBut_isr__INTC_MASK 0x04u
#define analogBut_isr__INTC_NUMBER 2u
#define analogBut_isr__INTC_PRIOR_NUM 5u
#define analogBut_isr__INTC_PRIOR_REG CYREG_NVIC_PRI_2
#define analogBut_isr__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define analogBut_isr__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* Clock_Echo */
#define Clock_Echo__CFG0 CYREG_CLKDIST_DCFG6_CFG0
#define Clock_Echo__CFG1 CYREG_CLKDIST_DCFG6_CFG1
#define Clock_Echo__CFG2 CYREG_CLKDIST_DCFG6_CFG2
#define Clock_Echo__CFG2_SRC_SEL_MASK 0x07u
#define Clock_Echo__INDEX 0x06u
#define Clock_Echo__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define Clock_Echo__PM_ACT_MSK 0x40u
#define Clock_Echo__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define Clock_Echo__PM_STBY_MSK 0x40u

/* Clock_OLED */
#define Clock_OLED__CFG0 CYREG_CLKDIST_DCFG1_CFG0
#define Clock_OLED__CFG1 CYREG_CLKDIST_DCFG1_CFG1
#define Clock_OLED__CFG2 CYREG_CLKDIST_DCFG1_CFG2
#define Clock_OLED__CFG2_SRC_SEL_MASK 0x07u
#define Clock_OLED__INDEX 0x01u
#define Clock_OLED__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define Clock_OLED__PM_ACT_MSK 0x02u
#define Clock_OLED__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define Clock_OLED__PM_STBY_MSK 0x02u
...
/* Timer_Mode */
#define Timer_Mode_TimerHW__CAP0 CYREG_TMR1_CAP0
#define Timer_Mode_TimerHW__CAP1 CYREG_TMR1_CAP1
#define Timer_Mode_TimerHW__CFG0 CYREG_TMR1_CFG0
#define Timer_Mode_TimerHW__CFG1 CYREG_TMR1_CFG1
#define Timer_Mode_TimerHW__CFG2 CYREG_TMR1_CFG2
#define Timer_Mode_TimerHW__CNT_CMP0 CYREG_TMR1_CNT_CMP0
#define Timer_Mode_TimerHW__CNT_CMP1 CYREG_TMR1_CNT_CMP1
#define Timer_Mode_TimerHW__PER0 CYREG_TMR1_PER0
#define Timer_Mode_TimerHW__PER1 CYREG_TMR1_PER1
#define Timer_Mode_TimerHW__PM_ACT_CFG CYREG_PM_ACT_CFG3
#define Timer_Mode_TimerHW__PM_ACT_MSK 0x02u
#define Timer_Mode_TimerHW__PM_STBY_CFG CYREG_PM_STBY_CFG3
#define Timer_Mode_TimerHW__PM_STBY_MSK 0x02u
#define Timer_Mode_TimerHW__RT0 CYREG_TMR1_RT0
#define Timer_Mode_TimerHW__RT1 CYREG_TMR1_RT1
#define Timer_Mode_TimerHW__SR0 CYREG_TMR1_SR0

/* UART_TOESP */
#define UART_TOESP_BUART_sRX_RxBitCounter__16BIT_CONTROL_AUX_CTL_REG CYREG_B0_UDB00_01_ACTL
#define UART_TOESP_BUART_sRX_RxBitCounter__16BIT_CONTROL_CONTROL_REG CYREG_B0_UDB00_01_CTL
#define UART_TOESP_BUART_sRX_RxBitCounter__16BIT_CONTROL_COUNT_REG CYREG_B0_UDB00_01_CTL
#define UART_TOESP_BUART_sRX_RxBitCounter__16BIT_COUNT_CONTROL_REG CYREG_B0_UDB00_01_CTL
#define UART_TOESP_BUART_sRX_RxBitCounter__16BIT_COUNT_COUNT_REG CYREG_B0_UDB00_01_CTL
#define UART_TOESP_BUART_sRX_RxBitCounter__16BIT_MASK_MASK_REG CYREG_B0_UDB00_01_MSK
#define UART_TOESP_BUART_sRX_RxBitCounter__16BIT_MASK_PERIOD_REG CYREG_B0_UDB00_01_MSK
#define UART_TOESP_BUART_sRX_RxBitCounter__16BIT_PERIOD_MASK_REG CYREG_B0_UDB00_01_MSK
#define UART_TOESP_BUART_sRX_RxBitCounter__16BIT_PERIOD_PERIOD_REG CYREG_B0_UDB00_01_MSK
#define UART_TOESP_BUART_sRX_RxBitCounter__CONTROL_AUX_CTL_REG CYREG_B0_UDB00_ACTL
#define UART_TOESP_BUART_sRX_RxBitCounter__CONTROL_REG CYREG_B0_UDB00_CTL
#define UART_TOESP_BUART_sRX_RxBitCounter__CONTROL_ST_REG CYREG_B0_UDB00_ST_CTL
#define UART_TOESP_BUART_sRX_RxBitCounter__COUNT_REG CYREG_B0_UDB00_CTL
#define UART_TOESP_BUART_sRX_RxBitCounter__COUNT_ST_REG CYREG_B0_UDB00_ST_CTL
#define UART_TOESP_BUART_sRX_RxBitCounter__MASK_CTL_AUX_CTL_REG CYREG_B0_UDB00_MSK_ACTL
#define UART_TOESP_BUART_sRX_RxBitCounter__PER_CTL_AUX_CTL_REG CYREG_B0_UDB00_MSK_ACTL
#define UART_TOESP_BUART_sRX_RxBitCounter__PERIOD_REG CYREG_B0_UDB00_MSK
#define UART_TOESP_BUART_sRX_RxBitCounter_ST__16BIT_STATUS_AUX_CTL_REG CYREG_B0_UDB00_01_ACTL
#define UART_TOESP_BUART_sRX_RxBitCounter_ST__16BIT_STATUS_REG CYREG_B0_UDB00_01_ST
#define UART_TOESP_BUART_sRX_RxBitCounter_ST__MASK_REG CYREG_B0_UDB00_MSK
#define UART_TOESP_BUART_sRX_RxBitCounter_ST__MASK_ST_AUX_CTL_REG CYREG_B0_UDB00_MSK_ACTL
#define UART_TOESP_BUART_sRX_RxBitCounter_ST__PER_ST_AUX_CTL_REG CYREG_B0_UDB00_MSK_ACTL
#define UART_TOESP_BUART_sRX_RxBitCounter_ST__STATUS_AUX_CTL_REG CYREG_B0_UDB00_ACTL
#define UART_TOESP_BUART_sRX_RxBitCounter_ST__STATUS_CNT_REG CYREG_B0_UDB00_ST_CTL
#define UART_TOESP_BUART_sRX_RxBitCounter_ST__STATUS_CONTROL_REG CYREG_B0_UDB00_ST_CTL
#define UART_TOESP_BUART_sRX_RxBitCounter_ST__STATUS_REG CYREG_B0_UDB00_ST
#define UART_TOESP_BUART_sRX_RxShifter_u0__16BIT_A0_REG CYREG_B0_UDB04_05_A0
#define UART_TOESP_BUART_sRX_RxShifter_u0__16BIT_A1_REG CYREG_B0_UDB04_05_A1
#define UART_TOESP_BUART_sRX_RxShifter_u0__16BIT_D0_REG CYREG_B0_UDB04_05_D0
#define UART_TOESP_BUART_sRX_RxShifter_u0__16BIT_D1_REG CYREG_B0_UDB04_05_D1
#define UART_TOESP_BUART_sRX_RxShifter_u0__16BIT_DP_AUX_CTL_REG CYREG_B0_UDB04_05_ACTL
#define UART_TOESP_BUART_sRX_RxShifter_u0__16BIT_F0_REG CYREG_B0_UDB04_05_F0
#define UART_TOESP_BUART_sRX_RxShifter_u0__16BIT_F1_REG CYREG_B0_UDB04_05_F1
#define UART_TOESP_BUART_sRX_RxShifter_u0__A0_A1_REG CYREG_B0_UDB04_A0_A1
#define UART_TOESP_BUART_sRX_RxShifter_u0__A0_REG CYREG_B0_UDB04_A0
#define UART_TOESP_BUART_sRX_RxShifter_u0__A1_REG CYREG_B0_UDB04_A1
#define UART_TOESP_BUART_sRX_RxShifter_u0__D0_D1_REG CYREG_B0_UDB04_D0_D1
#define UART_TOESP_BUART_sRX_RxShifter_u0__D0_REG CYREG_B0_UDB04_D0
#define UART_TOESP_BUART_sRX_RxShifter_u0__D1_REG CYREG_B0_UDB04_D1
#define UART_TOESP_BUART_sRX_RxShifter_u0__DP_AUX_CTL_REG CYREG_B0_UDB04_ACTL
#define UART_TOESP_BUART_sRX_RxShifter_u0__F0_F1_REG CYREG_B0_UDB04_F0_F1
#define UART_TOESP_BUART_sRX_RxShifter_u0__F0_REG CYREG_B0_UDB04_F0
#define UART_TOESP_BUART_sRX_RxShifter_u0__F1_REG CYREG_B0_UDB04_F1
#define UART_TOESP_BUART_sRX_RxSts__16BIT_STATUS_AUX_CTL_REG CYREG_B0_UDB07_08_ACTL
#define UART_TOESP_BUART_sRX_RxSts__16BIT_STATUS_REG CYREG_B0_UDB07_08_ST
#define UART_TOESP_BUART_sRX_RxSts__3__MASK 0x08u
#define UART_TOESP_BUART_sRX_RxSts__3__POS 3
#define UART_TOESP_BUART_sRX_RxSts__4__MASK 0x10u
#define UART_TOESP_BUART_sRX_RxSts__4__POS 4
#define UART_TOESP_BUART_sRX_RxSts__5__MASK 0x20u
#define UART_TOESP_BUART_sRX_RxSts__5__POS 5
#define UART_TOESP_BUART_sRX_RxSts__MASK 0x38u
#define UART_TOESP_BUART_sRX_RxSts__MASK_REG CYREG_B0_UDB07_MSK
#define UART_TOESP_BUART_sRX_RxSts__STATUS_AUX_CTL_REG CYREG_B0_UDB07_ACTL
#define UART_TOESP_BUART_sRX_RxSts__STATUS_REG CYREG_B0_UDB07_ST
#define UART_TOESP_BUART_sTX_sCLOCK_TxBitClkGen__16BIT_A0_REG CYREG_B0_UDB06_07_A0
#define UART_TOESP_BUART_sTX_sCLOCK_TxBitClkGen__16BIT_A1_REG CYREG_B0_UDB06_07_A1
#define UART_TOESP_BUART_sTX_sCLOCK_TxBitClkGen__16BIT_D0_REG CYREG_B0_UDB06_07_D0
#define UART_TOESP_BUART_sTX_sCLOCK_TxBitClkGen__16BIT_D1_REG CYREG_B0_UDB06_07_D1
#define UART_TOESP_BUART_sTX_sCLOCK_TxBitClkGen__16BIT_DP_AUX_CTL_REG CYREG_B0_UDB06_07_ACTL
#define UART_TOESP_BUART_sTX_sCLOCK_TxBitClkGen__16BIT_F0_REG CYREG_B0_UDB06_07_F0
#define UART_TOESP_BUART_sTX_sCLOCK_TxBitClkGen__16BIT_F1_REG CYREG_B0_UDB06_07_F1
#define UART_TOESP_BUART_sTX_sCLOCK_TxBitClkGen__A0_A1_REG CYREG_B0_UDB06_A0_A1
#define UART_TOESP_BUART_sTX_sCLOCK_TxBitClkGen__A0_REG CYREG_B0_UDB06_A0
#define UART_TOESP_BUART_sTX_sCLOCK_TxBitClkGen__A1_REG CYREG_B0_UDB06_A1
#define UART_TOESP_BUART_sTX_sCLOCK_TxBitClkGen__D0_D1_REG CYREG_B0_UDB06_D0_D1
#define UART_TOESP_BUART_sTX_sCLOCK_TxBitClkGen__D0_REG CYREG_B0_UDB06_D0
#define UART_TOESP_BUART_sTX_sCLOCK_TxBitClkGen__D1_REG CYREG_B0_UDB06_D1
#define UART_TOESP_BUART_sTX_sCLOCK_TxBitClkGen__DP_AUX_CTL_REG CYREG_B0_UDB06_ACTL
#define UART_TOESP_BUART_sTX_sCLOCK_TxBitClkGen__F0_F1_REG CYREG_B0_UDB06_F0_F1
#define UART_TOESP_BUART_sTX_sCLOCK_TxBitClkGen__F0_REG CYREG_B0_UDB06_F0
#define UART_TOESP_BUART_sTX_sCLOCK_TxBitClkGen__F1_REG CYREG_B0_UDB06_F1
#define UART_TOESP_BUART_sTX_TxShifter_u0__16BIT_A0_REG CYREG_B0_UDB07_08_A0
#define UART_TOESP_BUART_sTX_TxShifter_u0__16BIT_A1_REG CYREG_B0_UDB07_08_A1
#define UART_TOESP_BUART_sTX_TxShifter_u0__16BIT_D0_REG CYREG_B0_UDB07_08_D0
#define UART_TOESP_BUART_sTX_TxShifter_u0__16BIT_D1_REG CYREG_B0_UDB07_08_D1
#define UART_TOESP_BUART_sTX_TxShifter_u0__16BIT_DP_AUX_CTL_REG CYREG_B0_UDB07_08_ACTL
#define UART_TOESP_BUART_sTX_TxShifter_u0__16BIT_F0_REG CYREG_B0_UDB07_08_F0
#define UART_TOESP_BUART_sTX_TxShifter_u0__16BIT_F1_REG CYREG_B0_UDB07_08_F1
#define UART_TOESP_BUART_sTX_TxShifter_u0__A0_A1_REG CYREG_B0_UDB07_A0_A1
#define UART_TOESP_BUART_sTX_TxShifter_u0__A0_REG CYREG_B0_UDB07_A0
#define UART_TOESP_BUART_sTX_TxShifter_u0__A1_REG CYREG_B0_UDB07_A1
#define UART_TOESP_BUART_sTX_TxShifter_u0__D0_D1_REG CYREG_B0_UDB07_D0_D1
#define UART_TOESP_BUART_sTX_TxShifter_u0__D0_REG CYREG_B0_UDB07_D0
#define UART_TOESP_BUART_sTX_TxShifter_u0__D1_REG CYREG_B0_UDB07_D1
#define UART_TOESP_BUART_sTX_TxShifter_u0__DP_AUX_CTL_REG CYREG_B0_UDB07_ACTL
#define UART_TOESP_BUART_sTX_TxShifter_u0__F0_F1_REG CYREG_B0_UDB07_F0_F1
#define UART_TOESP_BUART_sTX_TxShifter_u0__F0_REG CYREG_B0_UDB07_F0
#define UART_TOESP_BUART_sTX_TxShifter_u0__F1_REG CYREG_B0_UDB07_F1
#define UART_TOESP_BUART_sTX_TxSts__0__MASK 0x01u
#define UART_TOESP_BUART_sTX_TxSts__0__POS 0
#define UART_TOESP_BUART_sTX_TxSts__1__MASK 0x02u
#define UART_TOESP_BUART_sTX_TxSts__1__POS 1
#define UART_TOESP_BUART_sTX_TxSts__16BIT_STATUS_AUX_CTL_REG CYREG_B1_UDB07_08_ACTL
#define UART_TOESP_BUART_sTX_TxSts__16BIT_STATUS_REG CYREG_B1_UDB07_08_ST
#define UART_TOESP_BUART_sTX_TxSts__2__MASK 0x04u
#define UART_TOESP_BUART_sTX_TxSts__2__POS 2
#define UART_TOESP_BUART_sTX_TxSts__3__MASK 0x08u
#define UART_TOESP_BUART_sTX_TxSts__3__POS 3
#define UART_TOESP_BUART_sTX_TxSts__MASK 0x0Fu
#define UART_TOESP_BUART_sTX_TxSts__MASK_REG CYREG_B1_UDB07_MSK
#define UART_TOESP_BUART_sTX_TxSts__STATUS_AUX_CTL_REG CYREG_B1_UDB07_ACTL
#define UART_TOESP_BUART_sTX_TxSts__STATUS_REG CYREG_B1_UDB07_ST
#define UART_TOESP_IntClock__CFG0 CYREG_CLKDIST_DCFG2_CFG0
#define UART_TOESP_IntClock__CFG1 CYREG_CLKDIST_DCFG2_CFG1
#define UART_TOESP_IntClock__CFG2 CYREG_CLKDIST_DCFG2_CFG2
#define UART_TOESP_IntClock__CFG2_SRC_SEL_MASK 0x07u
#define UART_TOESP_IntClock__INDEX 0x02u
#define UART_TOESP_IntClock__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define UART_TOESP_IntClock__PM_ACT_MSK 0x04u
#define UART_TOESP_IntClock__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define UART_TOESP_IntClock__PM_STBY_MSK 0x04u
...
/* WaveDAC8_2 */
#define WaveDAC8_2_BuffAmp_ABuf__CR CYREG_OPAMP1_CR
#define WaveDAC8_2_BuffAmp_ABuf__MX CYREG_OPAMP1_MX
#define WaveDAC8_2_BuffAmp_ABuf__NPUMP_OPAMP_TR0 CYREG_NPUMP_OPAMP_TR0
#define WaveDAC8_2_BuffAmp_ABuf__PM_ACT_CFG CYREG_PM_ACT_CFG4
#define WaveDAC8_2_BuffAmp_ABuf__PM_ACT_MSK 0x02u
#define WaveDAC8_2_BuffAmp_ABuf__PM_STBY_CFG CYREG_PM_STBY_CFG4
#define WaveDAC8_2_BuffAmp_ABuf__PM_STBY_MSK 0x02u
#define WaveDAC8_2_BuffAmp_ABuf__RSVD CYREG_OPAMP1_RSVD
#define WaveDAC8_2_BuffAmp_ABuf__SW CYREG_OPAMP1_SW
#define WaveDAC8_2_BuffAmp_ABuf__TR0 CYREG_OPAMP1_TR0
#define WaveDAC8_2_BuffAmp_ABuf__TR1 CYREG_OPAMP1_TR1
...
/* Timer_Display */
#define Timer_Display_TimerHW__CAP0 CYREG_TMR0_CAP0
#define Timer_Display_TimerHW__CAP1 CYREG_TMR0_CAP1
#define Timer_Display_TimerHW__CFG0 CYREG_TMR0_CFG0
#define Timer_Display_TimerHW__CFG1 CYREG_TMR0_CFG1
#define Timer_Display_TimerHW__CFG2 CYREG_TMR0_CFG2
#define Timer_Display_TimerHW__CNT_CMP0 CYREG_TMR0_CNT_CMP0
#define Timer_Display_TimerHW__CNT_CMP1 CYREG_TMR0_CNT_CMP1
#define Timer_Display_TimerHW__PER0 CYREG_TMR0_PER0
#define Timer_Display_TimerHW__PER1 CYREG_TMR0_PER1
#define Timer_Display_TimerHW__PM_ACT_CFG CYREG_PM_ACT_CFG3
#define Timer_Display_TimerHW__PM_ACT_MSK 0x01u
#define Timer_Display_TimerHW__PM_STBY_CFG CYREG_PM_STBY_CFG3
#define Timer_Display_TimerHW__PM_STBY_MSK 0x01u
#define Timer_Display_TimerHW__RT0 CYREG_TMR0_RT0
#define Timer_Display_TimerHW__RT1 CYREG_TMR0_RT1
#define Timer_Display_TimerHW__SR0 CYREG_TMR0_SR0

/* isr_checkMode */
#define isr_checkMode__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define isr_checkMode__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define isr_checkMode__INTC_MASK 0x40000u
#define isr_checkMode__INTC_NUMBER 18u
#define isr_checkMode__INTC_PRIOR_NUM 5u
#define isr_checkMode__INTC_PRIOR_REG CYREG_NVIC_PRI_18
#define isr_checkMode__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define isr_checkMode__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* isr_updateESP */
#define isr_updateESP__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
...
/* debouncerClock */
#define debouncerClock__CFG0 CYREG_CLKDIST_DCFG7_CFG0
#define debouncerClock__CFG1 CYREG_CLKDIST_DCFG7_CFG1
#define debouncerClock__CFG2 CYREG_CLKDIST_DCFG7_CFG2
#define debouncerClock__CFG2_SRC_SEL_MASK 0x07u
#define debouncerClock__INDEX 0x07u
#define debouncerClock__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define debouncerClock__PM_ACT_MSK 0x80u
#define debouncerClock__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define debouncerClock__PM_STBY_MSK 0x80u
...
#define CYDEV_INTR_RISING 0x0006037Du

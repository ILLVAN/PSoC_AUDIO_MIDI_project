...
uint8 squarewasve[4] = {252u,0u,252u,0u}; 
        ...
        switch (mode){
            ...
            case 3:
                if(button1){
                    WaveDAC8_1_Start();
                    UART_1_PutString("\r\n");
                    UART_1_PutChar(notes[button1][0]);
                    Clock_1_SetDividerValue(250000 / intFrequency[button1]);
                }
                    ...
                    Clock_1_SetDividerValue(250000 / intFrequency[button2]);
                }
                    ...
                    Clock_1_SetDividerValue(250000 / intFrequency[button3]);
                } else  {
                    WaveDAC8_1_Stop();
                }
